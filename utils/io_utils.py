...
def save_checkpoint(model, optimizer, args, num_epochs=-1, isbest=False, cg_dict=None):
    ...
    """
    filename = os.path.join("/gpfsdata/home/buaa_yanhongxi/Code/Desease/gnn/explain_data", args.save_tag) + ".pth.tar"
...
def load_ckpt(args, isbest=False):
    ...
    '''
    print("loading model")
    filename = "/gpfsdata/home/buaa_yanhongxi/Code/Desease/gnn/explain_data/correct_gnn_gbm_wb_es01_l2em64h64f32b32_hd256_pca_match_mask_sage_pyscenic_nes1.0_auc0.01_acc_feature_drop_weighted_edge_l1_reverse_mt_pass_cm_mm_mute12_ep30.pth.tar"
    print(filename)
